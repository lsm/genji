...
function Context(request, response) {
  ...
  injector.regDependency('context', this);
  injector.regDependency('req', request);
  injector.regDependency('res', response);
  injector.reflect(injector, ['regDependency', 'getDependency', 'getDependencies'], this);
}
