...
module.exports = {
    ...
    make: function(settings, conf) {
        var rules = typeof conf.urls === 'string' ? require(path.join(settings.env.root, conf.urls)) : conf.urls;
        ...
        return function(req, res, go) {
            route.call(this, {type: req.method, condition: req.url}, rules, function() {
                flaker.emit('error', {
                    code: 404,
