...
Router.prototype = {
  ...
  'delete': function (url, handleFunction, hooks) {
    this.mount([
      [url, handleFunction, 'delete', hooks]
    ]);
  },
  ...
  notFound: function (url, handleFunction, hooks) {
    this.mount([
      [url, handleFunction, 'notFound', hooks]
    ]);
  },
