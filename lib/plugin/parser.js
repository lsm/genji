...
module.exports = {
  ...
  attach: function (core, options) {
    ...
    options.maxPostSize = options.maxPostSize || 256 * 1024;
    ...
    return function (request, response, go) {
      ...
      if (request.method === 'POST' || request.method === 'PUT') {
        ...
        if (isNaN(contentLength) || contentLength > options.maxPostSize) {
          // not a vaild request
        ...
        request.on("data", function (chunk) {
          buff += chunk;
          if (Buffer.byteLength(buff, options.encoding) > options.maxPostSize) {
            request.removeAllListeners();
            request.connection.destroy();
          }
        });
